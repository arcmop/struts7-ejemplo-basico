...
<html lang="<s:property value='%{locale.language}' />">
    <head>
        ...
        <title><s:text name="password.change.title" /></title>
    ...
    <body>
        <div class="container py-5">
                ...
                <div class="hero-content d-flex flex-column flex-lg-row gap-4 align-items-start align-items-lg-center">
                    <div>
                        <span class="badge badge-soft text-uppercase mb-3">
                            <s:text name="password.change.badge" />
                        </span>
                        <h1 class="display-6 fw-bold mb-2"><s:text name="password.change.title" /></h1>
                        <p class="mb-0 text-white-50"><s:text name="password.change.subtitle" /></p>
                    </div>
            ...
            <s:url var="formActionUrl" action="password-actualizar" />
            <div class="card form-card">
                <div class="card-body p-4">
                    <form action="<s:property value='#formActionUrl' />" method="post" class="row g-3">
                        <div class="col-12">
                            <label class="form-label"><s:text name="password.current" /></label>
                            <input
                                class="form-control"
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label"><s:text name="password.new" /></label>
                            <input
                                class="form-control"
                                name="newPassword"
                                type="password"
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label"><s:text name="password.new.confirm" /></label>
                            <input
                                class="form-control"
                        ...
                        <div class="col-12 d-flex flex-wrap gap-2 pt-2">
                            <button type="submit" class="btn btn-primary">
                                ...
                                <s:text name="button.password.change" />
                            </button>
