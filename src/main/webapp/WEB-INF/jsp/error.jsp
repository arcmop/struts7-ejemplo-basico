...
<html lang="<%= request.getLocale().getLanguage() %>">
    <head>
        ...
        <title>Error | Ocurri&oacute; un problema</title>
        ...
        <div class="container py-5">
            <div class="hero p-4 p-md-5 mb-4">
                <div class="hero-content d-flex flex-column flex-lg-row gap-4 align-items-start align-items-lg-center">
                    <div>
                        <span class="badge badge-soft text-uppercase mb-3">Error</span>
                        <h1 class="display-6 fw-bold mb-2">Ocurri&oacute; un problema</h1>
                        <p class="mb-0 text-white-50">
                            No se pudo completar la operaci&oacute;n solicitada.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card form-card">
                <div class="card-body p-4 d-flex flex-column gap-3">
                    <p class="mb-0">
                        Intenta nuevamente o vuelve al listado de productos.
                    </p>
                    <div>
