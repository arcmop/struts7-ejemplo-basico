...
<html lang="<s:property value='%{locale.language}' />">
    ...
    <body>
        ...
        <s:url var="productosUrl" action="productos" />
        <div class="container py-5">
            <div class="hero p-4 p-md-5 mb-4 animate__animated animate__fadeIn">
                <div class="hero-content d-flex flex-column flex-lg-row gap-4 align-items-start align-items-lg-center">
                    ...
                    <div class="ms-lg-auto d-none d-lg-flex flex-column flex-sm-row gap-3 align-items-start align-items-sm-center">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between mb-3 gap-3">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 flex-grow-1">
                    ...
                    <form action="<s:property value='#productosUrl' />" method="get" class="search-inline d-flex align-items-center gap-2">
                        <label for="tituloSearch" class="visually-hidden"><s:text name="search.label" /></label>
                        <div class="input-group input-group-sm">
                            ...
                            <input
                                ...
                                type="search"
                                name="tituloBusqueda"
                                value="<s:property value='tituloBusqueda' />"
                                class="form-control"
                                maxlength="120"
                                placeholder="<s:text name='search.placeholder' />" />
                        </div>
                    </form>
                </div>
                <div class="d-flex flex-wrap align-items-center gap-3">
                    <div class="lang-switch d-flex align-items-center gap-2">
                        ...
                        <div class="btn-group btn-group-sm" role="group" aria-label="<s:text name='language.label' />">
                            <s:a action="productos" cssClass="btn btn-outline-secondary">
                                ...
                                <s:if test="busquedaActiva">
                                    <s:param name="tituloBusqueda" value="tituloBusqueda" />
                                </s:if>
                    ...
                    <s:if test="autenticado">
                        ...
                        <s:if test="#isAdminSession">
                            <div class="dropdown admin-actions-menu">
                                <button
                                    class="btn btn-primary btn-sm dropdown-toggle admin-menu-toggle"
                                    type="button"
                                    data-bs-toggle="dropdown"
                                    aria-expanded="false"
                                    aria-label="<s:text name='menu.admin.actions' />">
                                    <i class="fa-solid fa-bars me-1"></i>
                                    <span class="d-none d-lg-inline"><s:text name="menu.admin.actions" /></span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                    <li>
                                        <s:a action="producto-nuevo" cssClass="dropdown-item">
                                            <i class="fa-solid fa-circle-plus me-2"></i>
                                            <s:text name="button.new" />
                                        </s:a>
                                    </li>
                                    <li>
                                        <s:a action="usuario-nuevo" cssClass="dropdown-item">
                                    ...
                                    <li>
                                        <s:a action="password-cambiar" cssClass="dropdown-item">
            ...
            <s:else>
                <div class="alert alert-info d-flex align-items-center gap-2" role="alert">
                    ...
                    <div>
                        <s:if test="busquedaActiva">
                            <s:text name="empty.search.message">
                                <s:param value="tituloBusqueda" />
                            </s:text>
                        </s:if>
                        <s:else>
                            <s:text name="empty.message" />
                        </s:else>
                    </div>
                </div>
            </s:else>
