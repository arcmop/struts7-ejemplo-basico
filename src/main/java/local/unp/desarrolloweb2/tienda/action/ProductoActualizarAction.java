 ...
 * @author mastermind
 */
public class ProductoActualizarAction extends ActionSupport implements SessionAware {
    ...
    public String execute() {
        ...
        tiendaService.actualizarProducto(producto, resolveActorUsername());
        return SUCCESS;
    }
    ...
    public void validate() {
        ...
        if (producto.getId() == null) {
            addFieldError("producto.id", getText("error.producto.id"));
        }
